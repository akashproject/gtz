@extends('layouts.main')
    ...
    @section('content')
        ...
        <div class="container-fluid bg-breadcrumb" style="background: linear-gradient(rgba(255, 255, 255, 0.5), rgba(0, 0, 0, 0.5)), url({{ url('assets/frontend/img/about-us.jpg') }});background-repeat: no-repeat;background-size: cover;">
